# `chess_cli.py` - Line-by-Line Explanation
...
- Prints the main menu with game mode options.
...
- Sets up the game state and bots based on the selected mode and difficulty.
